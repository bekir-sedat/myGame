    ...
    public override void Rotate90()
    {
        ...
        switch (direction)
        {
            ...
            case 2:
                ...
                int newYY1 = (int)bricks[1].transform.position.y + 2;
            ...
            case 3:
                ...
                int newXXX0 = (int)bricks[0].transform.position.x - 1;
                int newYYY0 = (int)bricks[0].transform.position.y - 1;

                int newXXX1 = (int)bricks[1].transform.position.x - 2;
                ...
                int newXXX3 = (int)bricks[3].transform.position.x;
            ...
            case 4:
                ...
                int newYYYY1 = (int)bricks[1].transform.position.y - 2;
