...
public class EBlock : Block
{
    ...
    public void PlaceBricks()
    {
        ...
        GameObject g2 = Instantiate(brick, new Vector2(parent.x + 1, parent.y), Quaternion.identity) as GameObject;
        ...
        GameObject g3 = Instantiate(brick, new Vector2(parent.x - 1, parent.y), Quaternion.identity) as GameObject;
    ...
    public override void Rotate90()
    {
        ...
        switch (direction)
        {
            ...
            case 2:
                ...
                int newYY0 = (int)bricks[0].transform.position.y;
            ...
            case 3:
                ...
                int newYYY0 = (int)bricks[0].transform.position.y;

                int newXXX1 = (int)bricks[1].transform.position.x + 1;
                int newYYY1 = (int)bricks[1].transform.position.y + 1;

                int newXXX2 = (int)bricks[2].transform.position.x + 1;
                int newYYY2 = (int)bricks[2].transform.position.y - 1;

                int newXXX3 = (int)bricks[3].transform.position.x - 1;
                int newYYY3 = (int)bricks[3].transform.position.y + 1;
            ...
            case 4:
                ...
                int newXXXX0 = (int)bricks[0].transform.position.x;
                int newYYYY0 = (int)bricks[0].transform.position.y;

                int newXXXX1 = (int)bricks[1].transform.position.x - 1;
                int newYYYY1 = (int)bricks[1].transform.position.y + 1;

                int newXXXX2 = (int)bricks[2].transform.position.x + 1;
                int newYYYY2 = (int)bricks[2].transform.position.y + 1;

                int newXXXX3 = (int)bricks[3].transform.position.x - 1;
                int newYYYY3 = (int)bricks[3].transform.position.y - 1;
