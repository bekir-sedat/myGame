...
public class SBlock : Block
{
    ...
    public void PlaceBricks()
    {
        ...
        GameObject g0 = Instantiate(brick, new Vector2(parent.x + 1, parent.y), Quaternion.identity) as GameObject;
        ...
        GameObject g1 = Instantiate(brick, new Vector2(parent.x + 1, parent.y + 1), Quaternion.identity) as GameObject;
        ...
        GameObject g3 = Instantiate(brick, new Vector2(parent.x, parent.y + 2), Quaternion.identity) as GameObject;
    ...
    public override void Rotate90()
    {
        ...
        switch (direction)
        {
            ...
            case 1:
                int newX0 = (int)bricks[0].transform.position.x;
                int newY0 = (int)bricks[0].transform.position.y + 1;

                int newX1 = (int)bricks[1].transform.position.x - 1;
                int newY1 = (int)bricks[1].transform.position.y;

                int newX2 = (int)bricks[2].transform.position.x;
                int newY2 = (int)bricks[2].transform.position.y - 1;

                int newX3 = (int)bricks[3].transform.position.x - 1;
            ...
            case 2:
                ...
                int newXX0 = (int)bricks[0].transform.position.x - 1;
                int newYY0 = (int)bricks[0].transform.position.y + 1;

                int newXX1 = (int)bricks[1].transform.position.x;
                int newYY1 = (int)bricks[1].transform.position.y;

                int newXX2 = (int)bricks[2].transform.position.x + 1;
                int newYY2 = (int)bricks[2].transform.position.y + 1;

                int newXX3 = (int)bricks[3].transform.position.x + 2;
                int newYY3 = (int)bricks[3].transform.position.y;
            ...
            case 3:
                ...
                int newXXX0 = (int)bricks[0].transform.position.x;
                ...
                int newYYY3 = (int)bricks[3].transform.position.y + 2;
            ...
            case 4:
                ...
                int newXXXX3 = (int)bricks[3].transform.position.x - 2;
                int newYYYY3 = (int)bricks[3].transform.position.y;
