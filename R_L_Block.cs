    ...
    public override void Rotate90()
    {
        ...
        switch (direction)
        {
            ...
            case 1:
                ...
                int newY1 = (int)bricks[1].transform.position.y + 2;
                ...
                int newY3 = (int)bricks[3].transform.position.y;
            ...
            case 2:
                ...
                int newXX1 = (int)bricks[1].transform.position.x - 2;
                ...
                int newXX3 = (int)bricks[3].transform.position.x;
                int newYY3 = (int)bricks[3].transform.position.y - 2;
            ...
            case 3:
                ...
                int newXXX1 = (int)bricks[1].transform.position.x;
                int newYYY1 = (int)bricks[1].transform.position.y - 2;

                int newXXX2 = (int)bricks[2].transform.position.x + 1;
                int newYYY2 = (int)bricks[2].transform.position.y - 1;

                int newXXX3 = (int)bricks[3].transform.position.x + 2;
            ...
            case 4:
                ...
                int newXXXX1 = (int)bricks[1].transform.position.x + 2;
